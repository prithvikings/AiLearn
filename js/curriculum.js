export const levels = [
  ...
  { id: 8, title: "Orchestration", description: "Design reliable multi-step AI systems.", unlocked: false },
];
...
export const llmLessons = [
  { id: "llm-01", title: "Tokenization", description: "See how text becomes tokens before an LLM processes it.", difficulty: "Beginner", xp: 25, type: "tokenizer", objective: "Understand that models operate on token IDs rather than raw text.", content: "<p>Language models receive token sequences. A tokenizer maps text into pieces such as words, subwords, punctuation, or whitespace patterns, depending on the tokenizer.</p>", visual: ["I", "love", "building", "AI", "apps"], quiz: { question: "What does a tokenizer do?", options: ["Turns text into tokens", "Creates database tables", "Chooses a GPU", "Stores model weights"], answer: 0 } },
  { id: "llm-02", title: "Embeddings", description: "Understand how tokens are represented as vectors inside a model.", difficulty: "Beginner", xp: 25, type: "embeddings", objective: "See why tokens need numerical representations before neural network computation.", content: "<p>Tokens are mapped into numerical vectors called embeddings. These vectors provide a continuous representation that downstream model layers can transform.</p>", examples: ["cat", "dog", "car"], quiz: { question: "What is an embedding?", options: ["A numerical vector representation", "A prompt template", "A database index", "A browser setting"], answer: 0 } },
  { id: "llm-03", title: "Attention", description: "Explore how tokens can focus on other tokens in context.", difficulty: "Intermediate", xp: 25, type: "attention", objective: "Build intuition for how attention connects context to relevant tokens.", content: "<p>Attention lets a token weigh information from other tokens in the sequence. This helps a model use context when transforming representations.</p>", visual: ["The", "chef", "added", "cheese", "to", "the", "pasta"], quiz: { question: "What does attention help a model do?", options: ["Relate tokens using context", "Store files permanently", "Choose a database", "Compress images"], answer: 0 } },
  { id: "llm-04", title: "Transformer Flow", description: "Trace the path from input tokens through a transformer block.", difficulty: "Intermediate", xp: 25, type: "flow", objective: "Understand the high-level sequence of transformations in a transformer.", content: "<p>A transformer repeatedly transforms token representations using attention and feed-forward layers. The output representations are used for the next prediction.</p>", visual: ["Input", "Embedding", "Attention", "Feed Forward", "Output"], quiz: { question: "Which component is central to a transformer?", options: ["Attention", "CSS", "HTTP", "SQL"], answer: 0 } },
  { id: "llm-05", title: "Next-Token Prediction", description: "Watch an illustrative sequence of candidate next tokens.", difficulty: "Intermediate", xp: 25, type: "generation", objective: "Understand generation as repeated next-token selection.", content: "<p>A text-generation LLM produces a sequence by selecting a next token from a probability distribution, then repeating with the updated context.</p>", generation: { prompt: "The sky is", steps: [{ token: "blue", probability: 70, alternatives: [["green", 15], ["clear", 8], ["bright", 4]] }, { token: "and", probability: 52, alternatives: [["very", 20], ["so", 12], ["today", 6]] }, { token: "clear", probability: 61, alternatives: [["bright", 16], ["wide", 9], ["calm", 5]] }, { token: "today", probability: 58, alternatives: [["outside", 17], ["above", 11], ["here", 6]] }] }, quiz: { question: "What is the core idea behind text generation in an LLM?", options: ["Repeatedly predicting the next token from context", "Looking up every sentence in a database", "Choosing a random paragraph once", "Rendering the answer with CSS"], answer: 0 } },
  { id: "llm-06", title: "Parameters", description: "Understand parameters as learned numerical values inside a model.", difficulty: "Intermediate", xp: 25, type: "parameters", objective: "Understand what parameters are and why model size matters.", content: "<p>Parameters are learned numerical values adjusted during training. They store patterns the model can use when transforming representations and making predictions.</p>", quiz: { question: "Which statement about parameters is correct?", options: ["They are learned numerical values inside a model", "They are user questions", "They are database records", "They are browser settings"], answer: 0 } },
  { id: "llm-07", title: "Temperature", description: "See how temperature changes the shape of token probabilities.", difficulty: "Intermediate", xp: 25, type: "sampling", objective: "Understand temperature as a control over output distribution sharpness.", content: "<p>Temperature rescales logits before converting them to probabilities. Lower values generally concentrate probability mass; higher values make the distribution flatter.</p>", quiz: { question: "What does lower temperature generally do?", options: ["Makes the distribution more concentrated and selection more predictable", "Adds parameters", "Removes tokenization", "Turns the model into a search engine"], answer: 0 } },
  { id: "llm-08", title: "Top-k and Top-p", description: "Compare two ways to restrict candidate tokens during sampling.", difficulty: "Intermediate", xp: 25, type: "sampling", objective: "Distinguish fixed-candidate top-k from probability-mass-based top-p sampling.", content: "<p>Top-k keeps the k highest-probability candidates. Top-p keeps the smallest set whose cumulative probability crosses a threshold.</p>", quiz: { question: "What does top-k do?", options: ["Limits candidates to the k most probable choices", "Chooses every candidate", "Changes model size", "Converts tokens into English"], answer: 0 } },
  { id: "llm-final", title: "LLM Fundamentals Final Challenge", description: "Show that you can trace how an LLM turns context into generation.", difficulty: "Challenge", xp: 50, type: "final", objective: "Connect tokenization, embeddings, attention, prediction, and sampling into one mental model.", content: "<p>This final challenge checks whether the core LLM pipeline makes sense as one system.</p>", visual: ["Input", "Tokens", "Embeddings", "Attention", "Next token", "Sampling"], quiz: { question: "Which sequence best matches text generation?", type: "order", order: ["Input text", "Tokenization", "Transformer / attention", "Next-token prediction", "Output"] }, finalChallenge: [{ question: "Which statement about parameters is correct?", options: ["They are learned numerical values inside a model", "They are user questions", "They are database records", "They are browser settings"], answer: 0 }, { question: "What does lower temperature generally do?", options: ["Makes the distribution more concentrated and selection more predictable", "Adds parameters", "Removes tokenization", "Turns the model into a search engine"], answer: 0 }, { question: "What does top-k do?", options: ["Limits candidates to the k most probable choices", "Chooses every candidate", "Changes model size", "Converts tokens into English"], answer: 0 }, { question: "What does top-p do?", options: ["Chooses the smallest candidate group reaching a probability threshold", "Always chooses exactly three tokens", "Changes the number of model parameters", "Disables attention"], answer: 0 }, { question: "In one short sentence, explain what an LLM does when it generates text.", type: "short", answer: "predict" }] },
];
