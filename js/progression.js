import { levels as curriculumLevels, allCurriculumLessons, getCurriculumLevel as findLevel } from "./curriculum.js";
...
export const getCurriculumLevel = (levelId) => findLevel?.(levelId) || curriculumLevelById[levelId] || null;
