import { finalChallenge, foundationLessons, levels as curriculumMetadata, llmLessons, promptLessons } from "./curriculum.js";
...
export const curriculumLevels = curriculumMetadata.map((level, index) => ({ ...level, lessons: lessonGroups[index] || [] }));
